...
// 兼容性处理：确保全局可用的 DEFAULT_FORM 包含 core 期望的字段名
// （某些旧版数据文件使用不同字段名，页面逻辑依赖 targetRole/targetHealthPercent/hitRatePercent）
if (typeof window !== 'undefined') {
  window.DEFAULT_FORM = Object.assign({}, DEFAULT_FORM, {
    targetRole: DEFAULT_FORM.targetRole || DEFAULT_FORM.targetUnit,
    targetHealthPercent: DEFAULT_FORM.targetHealthPercent || DEFAULT_FORM.targetHealth,
    hitRatePercent: DEFAULT_FORM.hitRatePercent || DEFAULT_FORM.hitProbabilityPercent,
  });
}
